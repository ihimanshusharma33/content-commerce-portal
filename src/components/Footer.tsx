        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Empowering learners with instant access to expert PDF resources and comprehensive course materials for academic excellence.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 text-muted-foreground">
                ...
                <a href="mailto:support@amplifilearn.com" className="hover:text-primary transition-colors">
                  support@amplifilearn.com
                </a>
              </div>
              <div className="flex items-center space-x-3 text-muted-foreground">
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="text-sm text-muted-foreground">
              &copy; {currentYear} Amplifilearn. All rights reserved.
            </div>
