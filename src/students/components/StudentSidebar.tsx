...
const StudentSidebar: React.FC<StudentSidebarProps> = ({
  ...
  return (
    <aside className={`bg-white hidden border-r-2 relative h-[95vh] border-b-2 h-full md:block ${isSidebarOpen ? 'md:w-64' : 'md:w-20'} transition-all duration-300 w-full`}>
